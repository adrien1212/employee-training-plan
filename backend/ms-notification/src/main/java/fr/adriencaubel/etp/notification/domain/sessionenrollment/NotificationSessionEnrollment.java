...
public class NotificationSessionEnrollment {
    ...
    public static NotificationSessionEnrollment create(NotificationSessionEnrollmentType notificationType, LocalDateTime scheduledAt, NotificationSessionEnrollmentRequestModel payload) {
