...
public record EmployeeResponseModel(Long id, String firstName, String lastName, String email,
                                    DepartmentResponseModel department) {

    public static EmployeeResponseModel toDto(Employee employee) {
        return new EmployeeResponseModel(employee.getId(), employee.getFirstName(), employee.getLastName(), employee.getEmail(), DepartmentResponseModel.toDto(employee.getDepartment()));
    }
}
